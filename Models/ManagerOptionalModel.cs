...
namespace Trading_company.Models
{
    ...
    /// </summary>
    public sealed class ManagerOptionalModel 
    {
        /// <summary>
        ...
        public ManagerOptionalModel(int man_id, string email, string password, string fullname, double percent, DateTime hire_day, string? comments, string? leadfullname, int? parent_id)
        {
            this.man_id = man_id;
            this.email = email;
